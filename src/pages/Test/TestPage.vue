        ...
        <v-tab-item v-for="tab in tabs" :key="tab">
          ...
          <v-card v-if="tab === 'list'">
            <table>
              ...
              <tbody>
                <tr v-for="emp in getAllEmployee" :key="emp.id">
                  <td>
                    {{ emp }}
                  </td>
                </tr>
            ...
            <!-- <v-data-table :headers="headers" :items="getAllEmployee" :items-per-page="10" :search="search">
              <template v-slot:[`item.actions`]="{ item }">
                <v-icon small class="mr-2" @click="$router.push('/employee/' + item.id)">
                  mdi-pencil
                </v-icon>
...
<script>
import ModalAddEmployee from '../Employee/ModalAddEmployee.vue';
// import ModalConfirmDeleteEmployee from '../Employee/ModalConfirmDeleteEmployee.vue';
